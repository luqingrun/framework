...
<head>
    ...
    <meta charset="utf-8" />
    <title>Login Page - Demo UC</title>
                ...
                <div class="login-container">
                    <div class="center">
                        <h1>
                            ...
                            <span class="white" id="id-text2">UC</span>
                        </h1>
                        <h4 class="blue" id="id-company-text">&copy; 酒仙网</h4>
                    </div>
                                ...
                                <div class="widget-main">
                                    ...
                                    <form action="${pageContext.request.contextPath}/login" method="POST">
                                        <fieldset>
                                            ...
                                            <label class="block clearfix">
                                                    <input type="text" class="input-icon" placeholder="验证码" name="vcode"/>
                                                    <script language="JavaScript">
                                                        function reloadcode(){
                                                            var verify=document.getElementById('safecode');
                                                            verify.setAttribute('src','${pageContext.request.contextPath}/vcode?'+Math.random());
                                                            //这里必须加入随机数不然地址相同我发重新加载
                                                        }
                                                    </script>
                                                    <img style="cursor: pointer;" id="safecode" onclick="reloadcode();" src="${pageContext.request.contextPath}/vcode">
                                            </label>
